...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        SearchDBDao.createTable(db, ifNotExists);
        UsersDBDao.createTable(db, ifNotExists);
        UserInfoDBDao.createTable(db, ifNotExists);
        SearchNetKeyDBDao.createTable(db, ifNotExists);
    }
    
    /** Drops underlying database table using DAOs. */
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        SearchDBDao.dropTable(db, ifExists);
        UsersDBDao.dropTable(db, ifExists);
        UserInfoDBDao.dropTable(db, ifExists);
        SearchNetKeyDBDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(SearchDBDao.class);
        registerDaoClass(UsersDBDao.class);
        registerDaoClass(UserInfoDBDao.class);
        registerDaoClass(SearchNetKeyDBDao.class);
    }

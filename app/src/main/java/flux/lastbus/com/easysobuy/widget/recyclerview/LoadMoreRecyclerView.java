...
public class LoadMoreRecyclerView extends RecyclerView {
    ...
    public class AutoLoadAdapter extends Adapter<ViewHolder> {
        ...
        private AbsRefershAdapterDelegate mInternalAdapter;

        boolean isAddHeader;
        boolean isAddFooter;

        public AutoLoadAdapter(AbsRefershAdapterDelegate adapter) {
        ...
        public int getItemViewType(int position) {
            ...
            //加入底部Adapter
            if((position == footerPosition) && manager.isFooterEnable() && !isAddFooter && !isEmpty){
                isAddFooter = true;
                FooterViewAdapter footerView = manager.getFooterView();
        ...
        public int getItemCount() {
            ...
            if(manager.isHeaderEnable()&& !isAddFooter && !isEmpty) count++;
        ...
        public void setEmptyView(){
            EmptyViewAdapter emptyView = mInternalAdapter.getEmptyView();
            if(emptyView != null){
                List<AbsAdatperData> items = new ArrayList<>();
        ...
        public void setLoadAll(boolean isLoadAll){
            FooterViewAdapter footerView = mInternalAdapter.getAdapterDelegatesManager().getFooterView();
            if(footerView != null){
    ...
    public void setAdapter(Adapter adapter) {
        if (adapter != null) {
            mAutoLoadAdapter = new AutoLoadAdapter((AbsRefershAdapterDelegate) adapter);
        }

 ...
 */
public abstract class FooterViewAdapter<T extends AbsAdatperData, VH extends RecyclerView.ViewHolder> extends AbsListItemAdapterDelegate<T,VH> {
     ...
     * @return
     */
    public abstract boolean isFooterViewType(AbsAdatperData t);
     ...
     * @return
     */
    public abstract AbsAdatperData getFooterView();

...
import flux.lastbus.com.easysobuy.ui.adapter.SearchAdapter;
import flux.lastbus.com.easysobuy.utils.AnimationUtil;
...
public class MaterialSearchView extends FrameLayout implements Filter.FilterListener {
    ...
    private void showBg(){
        /*AlphaAnimation aAnima = new AlphaAnimation(0.5f, 1.0f);
        aAnima.setDuration(500);
        aAnima.setInterpolator(new AccelerateDecelerateInterpolator());
        mTintView.startAnimation(aAnima);*/
